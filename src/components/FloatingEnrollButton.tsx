  ...
  return (
    <>
      ...
      <Link
        ...
        className="fixed right-0 top-1/2 z-[100] hidden -translate-y-1/2 rotate-180 items-center justify-center bg-[#6a1b1b] px-2 py-4 text-[10px] tracking-[0.2em] font-bold text-white shadow-2xl transition hover:bg-[#4a1212] lg:flex rounded-lg"
